...
export default function Icon({ iconName, tooltip, color, iconSize, margin, htmlTooltip, float, onClick }: Props) {
    ...
    switch (iconName) {
        ...
        case 'brains':
            ...
            break
        case 'treasure':
            styling = "fa-solid fa-treasure-chest"
            break
        case 'book':
            styling = "fa-solid fa-books"
            break
        case 'monster':
            styling = "fa-solid fa-hydra"
            break
        case 'warning':
            styling = "fa-solid fa-diamond-exclamation"
            break
        case 'chart':
            styling = "fa-solid fa-chart-diagram"
            break
        case 'edit':
        ...
        case 'run':
            ...
            break
        case 'user':
            styling = "fa-solid fa-circle-user"
            break
        case 'check':
            styling = "fa-solid fa-check"
            break
        case 'Ko-fi':
            styling = "fa-brands fa-ko-fi"
            break
        case 'Discord':
            styling = "fa-brands fa-discord"
            break
        default:
            break;
    }

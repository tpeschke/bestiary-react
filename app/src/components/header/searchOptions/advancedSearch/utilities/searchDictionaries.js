export const sizeSearchDictionary = [
    'Fine',
    'Diminutive',
    'Tiny',
    'Small',
...
export const raritySearchDictionary = [
    {
        value: 'Legendary',
        id: 1
    },
...
export const accessSearchDictionary = [
    {
        value: 'Basic',
        id: 0
    },
...
export const minSkullSearchDictionary = [
    {
        value: 1,
        id: 0
    },
...
export const maxSkullSearchDictionary = [
    {
        value: 1,
        id: 3
    },
...
export const confrontationPrimaryDictionary = [
    { id: 1, value: 'Striker' },
    { id: 2, value: 'Defender' },
...
export const confrontationSecondaryDictionary = [
    { id: 32, value: 'Elite' },
    { id: 33, value: 'Solo' }
];
export const combatPrimaryDictionary = [
...
export const combatSecondaryDictionary = [
    { id: 18, value: 'Fodder' },
    { id: 31, value: 'Elite' },
    { id: 21, value: 'Solo' },
];
export const skillPrimaryDictionary = [
    { id: 22, value: 'Hunter' },
    { id: 23, value: 'Prey' },
...
export const skillSecondaryDictionary = [
    { id: 34, value: 'Elite' },
    { id: 35, value: 'Solo' }
];
export const typeSearchDictionary = [

...
export default function StrategiesNLimits({ strategiesNLimits, limitNotes }: Props) {
    ...
    const chaosTooltip = systemPreference === BONFIRE ? chaosNDiminishTooltip : 'This is the number of enemies that need to be killed to trigger a Diminish Check.'
    const diminishTooltip = systemPreference === BONFIRE ? chaosNDiminishTooltip : 'This is the chance of the Diminish Check being successful.'

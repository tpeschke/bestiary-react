...
export default function Step1() {
    return (
        <div>
            ...
            <p className="italic">My players will be traveling through a swamp in the next session and I want the swamp to be scary and put the characters on edge so I’m going to select Fearful as the Emotion. I could also choose Scared or even Frightened but Fearful already captured that.</p>

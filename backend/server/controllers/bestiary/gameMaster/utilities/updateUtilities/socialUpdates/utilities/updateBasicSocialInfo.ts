...
export default async function updateBasicSocialInfo(beastID: number, socialInfo: NonspecificSocialInfo) {
    ...
    atk_conf = $7, atk_conf_hm = $8, def_conf = $9, def_conf_hm = $10
    where id = $1`

    const { socialSkulls, socialRawEpValue, socialRole, socialSecondary, capacity, attackInfo, defenseInfo } = socialInfo

    return query(sqlQuery, [
        beastID, socialSkulls, socialRawEpValue, socialRole, socialSecondary, capacity.strength,

...
export const enchantedItemChanceScaling = {
    a: 0,
    b: .5,
    c: 1,
    d: 1.5,
...
export const talismanPotionScrollAlmScriptScaling = {
    a: -20,
    b: -4,
    c: -2,
    d: 0,
...
export const spellPointsFavorScaling = {
    a: 0,
    b: 1,
    c: 1.25,
    d: 1.5,
...
export const uniqueItemChanceScaling = {
    a: 0,
    b: .5,
    c: 1,
    d: 1.5,

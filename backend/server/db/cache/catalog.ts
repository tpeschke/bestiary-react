export const getCatalogTilesByLetter = `select id, name, patreon, canplayerview, thumbnail, hash, role, secondaryrole, socialrole, skillrole, defaultrole, socialsecondary, rarity, skillsecondary from bbindividualbeast 
where UPPER(name) like $1 ||'%' and UPPER(name) not like 'TEMPLATE,%' and userid is null
order by name asc`

export const getFreeCatalogTiles = `select id, name, patreon, canplayerview, thumbnail, hash, role, secondaryrole, socialrole, skillrole, defaultrole, socialsecondary, rarity, skillsecondary from bbindividualbeast 
...
export const getTemplateForCatalog = `select id, name, patreon, canplayerview, thumbnail, hash, role, secondaryrole, socialrole, skillrole, defaultrole, socialsecondary, rarity, skillsecondary from bbindividualbeast 

...
(
    ...
    '<p>Magma Spit: Ranged attack that leaves burning patches on the ground; On a Trauma Check, roll dX! and make the target Trauma''d on a burst while its armor gains 1 Wear.</p>',
    '<p>Heat Shimmer: When the Ashenwyrm Parries an attack, it gains +2 Pos and the attacker suffers Fatigue And Stress from the furnace glare.</p>',
...
(
    ...
    '<p>Thorn Volley: Launches a spray of barbed thorns; On Trauma Check, barbs twist deeper, add X Wear to shields, and drain Endurance.</p>',
    '<p>Briar Armor: When the Boggart Parries an attack, brambles snag the weapon, inflict 1 Wear, and grant Recovery from Stress.</p>',
...
(
    ...
    '<p>Ember Charge: A rushing antler attack that ignites the target; On a Trauma Check, the target is Trauma''d by ancestral fire and loses Recovery until cooled.</p>',
    '<p>Ashen Ward: Allies within 15ft gain Vitality against flame, reduce incoming Wear by 1, and ignore Fatigue from smoke.</p>',
...
(
    ...
    '<p>Shadow Bite: Melee attack that reduces the target''s darkvision range; On Trauma Check, the bite also drains Vitality and Mem.</p>',
    '<p>Light Eater: Can suppress magical and mundane light within 30ft, gaining Recovery when it Parries an attack in darkness and converting glare into Stress.</p>',
...
(
    ...
    '<p>Boulder Hurl: Ranged attack with a massive thrown stone; On Trauma Check, targets are knocked prone, gain Fatigue, and lose +2 Pos.</p>',
    '<p>Iron Skin: Reduces all physical damage by a flat amount; weapons gain 1 Wear when the Troll Parries an attack, and the Troll spends Endurance for Recovery.</p>',
